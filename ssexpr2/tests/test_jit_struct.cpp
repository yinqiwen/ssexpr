...
#include "ssexpr2/jit_struct_helper.h"
...
TEST(ReflectVisistTest, FlatBuffers) {
  ...
  ssexpr2::ValueAccessor access = ssexpr2::GetFieldAccessors<JitStructHelper<test_fbs::Data>>(names);
  auto v = access(t);
...
TEST(ReflectVisistTest, ProtoBuffers) {
  ...
  ssexpr2::ValueAccessor access = ssexpr2::GetFieldAccessors<JitStructHelper<test_proto::Data>>(names);
  auto v = access(&test);
