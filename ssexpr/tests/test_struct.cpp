...
#include "ssexpr/expr_struct_helper.h"
...
DEFINE_EXPR_STRUCT(Item2, (double)score, (std::string)id, (int32_t)vv,
                   (SubItem2 *)sub)
...
DEFINE_EXPR_STRUCT(Item3, (double)score, (std::string)id, (int32_t)vv,
                   (SubItem3)sub)
...
DEFINE_EXPR_STRUCT(PbFbsData, (const test_proto::Data *)pb,
                   (const test_fbs::Data *)fbs)
